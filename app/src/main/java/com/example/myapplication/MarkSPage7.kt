...
class MarkSPage7 : ComponentActivity() {
                                    ...
                                    Surface {
                                        ...
                                        NavHost(
                                            ...
                                            composable("Start") {
                                                ...
                                                background(resultList, navController,"7th")
                                            }
                                            ...
                                            composable("nextpage") {
                                                ...
                                                if (!markSPage2Launched) {
                                                    // Launch MarkSPage2
                                                    val intent = Intent(this@MarkSPage7, MarkSPage8::class.java)
    ...
    private fun showToast(message: String) {
        showToast(this@MarkSPage7, message)
    }
