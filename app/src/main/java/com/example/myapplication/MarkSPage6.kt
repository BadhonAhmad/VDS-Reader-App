...
class MarkSPage6 : ComponentActivity() {
                                    ...
                                    Surface {
                                        ...
                                        NavHost(
                                            ...
                                            composable("Start") {
                                                ...
                                                background(resultList, navController,"6th")
                                            }
                                            ...
                                            composable("nextpage") {
                                                ...
                                                if (!markSPage2Launched) {
                                                    // Launch MarkSPage2
                                                     val intent = Intent(this@MarkSPage6, MarkSPage7::class.java)
    ...
    private fun showToast(message: String) {
        showToast(this@MarkSPage6, message)
    }
