...
class MarkSPage3 : ComponentActivity() {
                                    ...
                                    Surface {
                                        ...
                                        NavHost(
                                            ...
                                            composable("Start") {
                                                ...
                                                background(resultList, navController,"3rd")
                                            }
                                            ...
                                            composable("nextpage") {
                                                ...
                                                if (!markSPage2Launched) {
                                                    // Launch MarkSPage2
                                                    val intent = Intent(this@MarkSPage3, MarkSPage4::class.java)
    ...
    private fun showToast(message: String) {
        showToast(this@MarkSPage3, message)
    }
